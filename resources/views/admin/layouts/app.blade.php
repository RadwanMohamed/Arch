            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu ">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li><!-- start message -->
                                        <a href="{{url('/admin-panel/contacts/'.$message->id.'/show')}}">
                                            <h4>
                                                {{$message->name}}
                            ...
                            <li class="footer"><a href="/admin-panel/contacts">See All Messages</a></li>
                        </ul>
                    </li>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                   @foreach(notification() as $noti)
                                    <li >
                                        <a class="pull-right" href="/admin-panel/buildings/{{$noti->id}}/edit">
                                            <i class="fa fa-users text-aqua"></i> تم اضافة عقار جديد
                                        </a>
                                        <button class="btn btn-secondary pull-left"><a  href="/admin-panel/buildings/{{$noti->id}}/activate"> تفعيل هذا العقار</a></button>
                                    </li>
                                    @endforeach
                                </ul>
                            </li>
                            <li class="footer"><a href="/admin-panel/buildings/">عرض الكل</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown user user-menu ">
                        ...
                        <ul class="dropdown-menu " style="margin-right: -180px">
                            <!-- User image -->
                            <li class="user-header">

                                <p>
                                   {{Auth::user()->name}}
                                    <small>العضوية منذ   {{Auth::user()->created_at->diffForHumans()}}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                                <div class="row">
                                    <div class="col-xs-4 text-center">
                                        <a href="/admin-panel/users/{{Auth::id()}}/buildings">
                                             العقارات
                                        </a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="{{route('buildings.create')}}">اضف عقار</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="/admin-panel/users"> الاعضاء</a>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </li>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/admin-panel/users/{{Auth::id()}}/edit" class="btn btn-default btn-flat">حسابي</a>
                                </div>
